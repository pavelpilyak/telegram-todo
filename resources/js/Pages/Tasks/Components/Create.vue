...
<template>
    <button
        ...
        class="fixed bottom-4 right-4 p-0 w-12 h-12 bg-gray-600 rounded-full hover:bg-blue-400 hover:text-white active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none tgButtonColor tgButtonTextColor"
    >
    ...
    <Modal :isOpen="isModalOpen" @close="isModalOpen = false">
        ...
        <template v-slot:actionButton>
            <button
                @click="handleSubmit"
                type="button"
                class="inline-flex w-full justify-center rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-blue-400 hover:text-white sm:ml-3 sm:w-auto tgButtonColor tgButtonTextColor"
            >
                Add
            </button>
        </template>
