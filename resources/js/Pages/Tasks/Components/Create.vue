    ...
    <Modal :isOpen="isModalOpen" @close="isModalOpen = false">
        ...
        <template v-slot:actionButton>
            <button
                @click="handleSubmit"
                type="button"
                class="inline-flex w-full justify-center rounded-md bg-gray-100 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-blue-300 hover:text-white sm:ml-3 sm:w-auto tgButtonColor tgButtonTextColor"
            >
                Add
            </button>
        </template>
